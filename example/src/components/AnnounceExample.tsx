    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Exercises every option exposed by{' '}
          <Text style={styles.bold}>ScreenReader.announce</Text> (calm) and the
          direct <Text style={styles.bold}>announce</Text> API.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.cardDesc}>
            ...
            before speaking.{'\n'}
            <Text style={styles.bold}>delayMs</Text> — direct mode only; ignored
            by the calm service.
          </Text>
          <View style={styles.row}>
            <Text style={styles.rowLabel}>queue</Text>
            <View style={styles.chipRow}>
              <Chip label="on" active={queue} onPress={() => setQueue(true)} />
              <Chip
                label="off"
                active={!queue}
      ...
      <View style={styles.actionCard}>
        <View style={styles.actionInfo}>
          ...
          <Text style={styles.actionDesc}>
            Fires three messages back-to-back — calm mode batches them into one
            300 ms debounced post; direct mode supersedes (only the last
            resolves as spoken).
          </Text>
        </View>
        <TouchableOpacity
      ...
      <View style={styles.actionCard}>
        <View style={styles.actionInfo}>
          ...
          <Text style={styles.actionDesc}>
            Navigates to a new screen while announcing the transition — calm
            mode handles nav-lock automatically
          </Text>
        </View>
        <TouchableOpacity
          style={[styles.btn, styles.btnOutline]}
          onPress={() => {
            post('Navigated to Unit Circle');
