...
export const UIContainerExample = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>A11y UI Container</Text>
      <Text style={styles.subtitle}>
        iOS only. Sets `UIAccessibilityContainerType` on the wrapping view so
        VoiceOver announces the right semantic grouping. Turn VoiceOver on and
        focus each section to hear the difference.
      </Text>
